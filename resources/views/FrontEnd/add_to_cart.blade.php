                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tr>
                                        <td class="image"><img src="/product/{{$cart->image}}" alt="#"></td>
                                        <td class="product-des">
                                            <h5 class="product-name">   {{$cart->product_title}}</h5>
                                        ...
                                        <td class="action" data-title="Remove"><a href="{{url('remove_cart',$cart->id)}}" class="text-muted" onclick="return confirm('Are you sure to remove this Product ?')"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="6" class="">
                                            ...
                                            <!-- <a href="#" class="text">TotalPrice:::<i class=""></i>  ${{$totalprice}}</a> -->
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <a href="{{url('cash_order')}}" class="btn "> <i class="fi-rs-box-alt mr-10"></i> Cash On Devliery</a>
                                    <a href="{{url('stripe_card',$totalprice)}}" class="btn "> <i class="fi-rs-box-alt mr-10"></i> Pay Using Card</a>
                                </div>
                            </div>
                        </div>
                    </div>
